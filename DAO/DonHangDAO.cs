...
namespace HTQLKhachHangThanThiet.DAO
{
    public class DonHangDAO
    {
        ...
        {
            DataProvider.Instance.RunQuery("DELETE FROM ChiTietDonHang WHERE MaDH=N'" + maDH + "'");
        ...
        public void capNhatTongTien(string maDH)
        {
            ...
            KhachHang kh = KhachHangDAO.Instance.getBySDT(getByMa(maDH).SdtKH);
            if(kh!=null)
            {
                int giamGia = HangDAO.Instance.getByMa(kh.MaHang).UuDai * tong / 100;
                DataProvider.Instance.RunQuery("UPDATE DonHang SET GiamGia=" + giamGia + " WHERE MaDH=N'" + maDH + "'");
            }    
        ...
        public void thanhToan(string maDH)
        {
            ...
            KhachHangDAO.Instance.updateTichLuy();
            KhachHangDAO.Instance.updateHang();
        }

    ...
    public partial class F_BanHang : Form
    {
        ...
        void loadDonChuaHT()
        {
            ...
            foreach (DonHang i in l)
            {
                ...
                row.Cells[7].Value = DataProvider.Instance.getDinhDanhHangNghin(i.GiamGia) + " VNĐ";
        ...
        private void showHoaDon()
        {
            ...
            if (dh != null)
            {
                tbTongHoaDon.Text = DataProvider.Instance.getDinhDanhHangNghin(dh.TongTien) + " VNĐ";
                tbThanhTien.Text = DataProvider.Instance.getDinhDanhHangNghin(dh.TongTien-dh.GiamGia) + " VNĐ";
                tbGiamGia.Text = DataProvider.Instance.getDinhDanhHangNghin(dh.GiamGia) + " VNĐ";
            }
            else
            {
                tbTongHoaDon.Text = "0 VNĐ";
                tbThanhTien.Text = "0 VNĐ";
                tbGiamGia.Text = "0 VNĐ";
            }
        }

...
namespace HTQLKhachHangThanThiet
{
    public partial class F_Bill : Form
    {
        ...
        private void showThongTin()
        {
            ...
            lbTongHoaDon.Text = DataProvider.Instance.getDinhDanhHangNghin(dh.TongTien) + " VNĐ";
            dgvCTHD.Rows.Clear();
            int stt = 0;
            ...
            lbGiamGia.Text= DataProvider.Instance.getDinhDanhHangNghin(dh.GiamGia) + " VNĐ";
            lbTongTien.Text= DataProvider.Instance.getDinhDanhHangNghin(dh.TongTien-dh.GiamGia) + " VNĐ";
        }
